...
describe Post do
  ...
  it "suupports reading and writing a title" do
    @it.title = "foo"
  ...
  it "supports setting sttributes in the initializer" do
  ...
  describe "#publish" do
    ...
    describe "#pubdate" do
      ...
      describe "after publishing" do
        before do
          @clock = stub!
          @now = DateTime.parse("2011-09-11T01:56")
          stub(@clock).now(){@now}
          @it.blog = stub!
          @it.publish(@clock)
        end
